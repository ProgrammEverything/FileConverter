...
./Platformer
```
Note: For building in release mode you can use the `-D CMAKE_BUILD_TYPE=Release` argument for cmake and for debug you can use the `-D CMAKE_BUILD_TYPE=Debug` cmake argument. (For a single configuration generator)